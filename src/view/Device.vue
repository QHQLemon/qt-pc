<template>
  <div class="device-wrapper container">
    <div class="device-top">
      <p class="main-title">设备概略</p>
      <p
        class="device-dire"
      >"我司自2004年创业以来，不断投资、更新设备，拥有两台先进的日本制造加工中心、十几台日系制造的CNC自动车床、十几台日本制造的滚齿机，还有大田精工自主设计开发并享有专利的干式高速滚齿机。一方面，中国国内制造的设备技术力量和服务也得到了提高，可以满足本公司所要求的高精密加工和质量的要求。超声波自动清洗机、滚齿机、滚丝机、线切割、无心磨、压花机等国内设备的投放，满足各种加工需求。另一方面，在质量保证体制方面，配备了三次元，轮廓议、圆度仪、齿轮测试仪等日本制的高精度测量仪品。"</p>
    </div>
    <div class="device-show">
      <p class="device-title">设备展示</p>
